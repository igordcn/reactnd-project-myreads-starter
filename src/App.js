        ...
        {this.state.showSearchPage ? (
          ...
          <div className="list-books">
            ...
            <div className="list-books-content">
              <div>
                <BookList title='Currently Read' books={this.state.books.filter(book => book.status === 'reading')}/>
                <BookList title='Want To Read' books={this.state.books.filter(book => book.status === 'want-to-read')}/>
                <BookList title='Read' books={this.state.books.filter(book => book.status === 'read')}/>
              </div>
            </div>
